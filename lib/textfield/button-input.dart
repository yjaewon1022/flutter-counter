//0-9 까지의 숫자가 입력이 가능하고
//+-/ 버튼도 추가하여 버튼을 이용한 계산기 프로그램 만들기를 진행
//숫자를 입력하고 난 뒤에 changeText에서 받아온 값이 +-*/ 중 하나라면
//지금까지 입력받았던 숫자를 num1 이라는 변수를 담고,
//이후에 숫자를 계속해서 입력받다가, 마지막으로 = 을 입력 받게 될 경우
//기존에 입력했엇던 +-*/ 연산자 자우 선택된 연산자를 통해 계산을 실행하면 된다.
// = 을 입력하면 기존에 있던 텍스틀은 사라지고, 결과가 입력창에 나와야 합니다.
  ...
  void changeText(String value) {
    setState(() {
      ...
      if (controller.text.isNotEmpty && value == "") {
        ...
        if (controller.text.isNotEmpty && !operatorEntered) {
