...
import 'day13/navigation/first.dart';
        ...
        children: [
          ElevatedButton(
            onPressed: () {
              ...
              // Navigator.push 사용방법 = Navigator.push(context, 이동 할 페이지)
              // MaterialPageRoute = 어떤 페이지로 이동할 지 컴퓨터에게 알려주는 친구
              ...
              // 이후에 push를 진행하면 배열 안에 [FirstPage()] 라는 값이 들어가게 되고,
              ...
              Navigator.push(
                ...
                // 데이터를 전달을 해야 할 땐 : MaterialPageRoute(builder: (context) => FirstPage(data:옮길데이터)),
                MaterialPageRoute(
